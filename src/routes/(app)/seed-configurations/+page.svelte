        ...
        <div class="max-w-[1600px] mx-auto px-6 py-4">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    <Puzzle size={20} />
                    <h1 class="text-lg font-semibold text-white/90">Seed Configurations</h1>
                    <span class="count-badge">{data.totalItems}</span>
                </div>
                <nav class="flex items-center gap-1">
                    ...
                    <a href="/seed-configurations" class="nav-link nav-link-active">
                        <Puzzle size={14} />
